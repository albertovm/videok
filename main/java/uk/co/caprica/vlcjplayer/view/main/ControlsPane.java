...
final class ControlsPane extends BasePanel {
    ...
    private final Icon analysisIcon = newIcon("analysis");
    ...
    ControlsPane(MediaPlayerActions mediaPlayerActions) {
        ...
        analysisButton = new StandardButton();
        ...
        setLayout(new MigLayout("fill, insets 0 0 0 0", "[]15[]0[]0[]80[]0[]0[]150[]push[]0[]", "[]"));
