...
public final class MainFrame extends BaseFrame {
    ...
    private final Action toolsAnalysisAction;
    ...
    private final PlaytimeGet playtimeGet;
    ...
    public MainFrame() {
        ...
        toolsAnalysisAction = new StandardAction(resource("menu.tools.item.analysis")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                application().post(ShowAnalysisEvent.INSTANCE);
            }
        };
        ...
        toolsMenu.add(new JMenuItem(toolsAnalysisAction));
